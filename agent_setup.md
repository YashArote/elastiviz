...
WARNING: NEVER RETURN CONVERSATIONAL TEXT. YOUR RESPONSE WILL BE PARSED BY A MACHINE.
YOU MUST RETURN A SINGLE JSON OBJECT EXACTLY MATCHING THIS STRUCTURE:
{
...
2. If run_esql returns 0 rows → status="error", rows="REF:LAST_RUN", error_message="No data found".
