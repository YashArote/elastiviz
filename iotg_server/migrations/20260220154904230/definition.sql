...
--
-- Class CapabilityRegistry as table capability_registry
--
...
--
-- Class DatasetRegistry as table dataset_registry
--
...
-- Indexes
CREATE INDEX "dataset_registry_name_idx" ON "dataset_registry" USING btree ("name");

--
-- Class FieldRegistry as table field_registry
--
...
--
-- Class MetricDictionary as table metric_dictionary
--
...
--
-- Class ObservabilityQuery as table observability_query
--
...
--
-- Class ObservabilityResult as table observability_result
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('iotg', '20260220154904230', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260220154904230', "timestamp" = now();
